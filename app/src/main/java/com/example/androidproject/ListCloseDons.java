...
public class ListCloseDons extends Fragment implements donAdapter.onItemClickListner {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_list_close_dons, container, false);
        mRecyclerView = v.findViewById(R.id.recycler_close_don);
        ...
        docUser.addSnapshotListener(getActivity(), new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                ...
                Log.d(TAG,"adresse user"+adresse);}
                }});
                ...
                if (task.isSuccessful()) {
                    ...
                    for (QueryDocumentSnapshot document : task.getResult()) {
                       ...
                       final String id = document.getId();
                        ...
                        final Object nom = document.getData().get("don");
                        a = nom.toString();
                   ...
                   if(adresse.equals(d)) {
                    ...
                    donAdapter.setOnItemClickListner(ListCloseDons.this);
                } else {
